    ...
    if 1.0 <= gpa_grade <= 1.5:
        ...
        return {
            ...
            "qualities": [
                "진로 목표에 대한 확고한 의지",
                "성장 잠재력과 발전 가능성",
                "실용적인 학습 능력 및 직업 세계에 대한 이해",
                "적극적인 태도와 대인 관계 능력"
            ],
            "efforts": [
                "자신의 강점과 흥미를 살릴 수 있는 전문대학교 또는 특정 분야 특성화 4년제 대학 탐색",
                "면접이나 자기소개서에서 자신의 열정과 경험을 효과적으로 어필하는 연습",
                "특기 및 적성을 보여줄 수 있는 활동 (예: 자격증 취득, 포트폴리오, 수상 경력)에 집중",
                "수능 최저 없는 전형, 면접 비중이 높은 전형 등 자신에게 유리한 전형 탐색",
                "희망하는 대학 및 학과의 졸업 후 진로, 취업률 등 구체적인 정보 확인"
            ],
            "study_methods": [
                "선택과 집중: 가장 자신 있는 과목 또는 등급을 올리기 쉬운 과목에 집중",
                "주요 개념 암기와 기본적인 문제 풀이 반복 학습",
                "틀린 문제의 오답을 반드시 확인하고 다시 풀어보는 습관",
                "온라인 학습 자료나 강좌를 활용하여 기초 개념 다지기",
                "꾸준히 공부하는 습관을 형성하고, 짧게라도 매일 학습하는 루틴 만들기"
            ],
            "lifestyle_tips": [
                "학습 시작 습관 만들고 긍정적인 태도로 임하기",
                "구체적인 학습 목표를 설정하고 달성하며 자신감 얻기",
                "불필요한 비교를 지양하고 자신의 성장에 집중",
                "충분한 휴식과 재충전을 통해 학습 피로도 관리",
                "규칙적인 운동으로 체력과 집중력 향상"
            ]
        }
    else:
        return {
    ...
    if 1.0 <= suneung_grade <= 1.5:
        ...
        return {
            ...
            "efforts": [
                ...
                "전문대학교 또는 4년제 대학 중 수능 성적 외의 요소 (예: 면접, 내신 일부)를 반영하는 곳 확인",
            ...
            "lifestyle_tips": [
                ...
                "구체적인 단기 학습 목표를 세우고 달성하며 성취감 느끼기",
...
# 입력 필드의 초기값을 송현2777님의 정보에 맞게 조절할 수도 있습니다.
# 예를 들어, Long_Term_Memory의 국어 3등급, 수학 4등급, 영어 5등급을 고려하여
# 평균 등급을 설정할 수 있지만, 여기서는 평균 3.0으로 유지합니다.
initial_gpa_value = 3.0
initial_suneung_value = 3.0 # 수능 등급은 임의 설정
